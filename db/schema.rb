...
ActiveRecord::Schema.define(version: 20170417204945) do
  ...
  create_table "monuments", force: :cascade do |t|
    ...
    t.integer  "town_id"
    t.index ["category_id"], name: "index_monuments_on_category_id", using: :btree
    t.index ["town_id"], name: "index_monuments_on_town_id", using: :btree
  ...
  add_foreign_key "monuments", "towns"
