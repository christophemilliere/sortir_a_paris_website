...
RSpec.describe MonumentsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested monument as @monument" do
      monument = Monument.create! valid_attributes
      get :show, params: {id: monument.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested monument as @monument" do
      monument = Monument.create! valid_attributes
      get :edit, params: {id: monument.to_param}, session: valid_session
      expect(assigns(:monument)).to eq(monument)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Monument" do
        expect {
          post :create, params: {monument: valid_attributes}, session: valid_session
      ...
      it "redirects to the created monument" do
        post :create, params: {monument: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Monument.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved monument as @monument" do
        post :create, params: {monument: invalid_attributes}, session: valid_session
        expect(assigns(:monument)).to be_a_new(Monument)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested monument" do
        monument = Monument.create! valid_attributes
        put :update, params: {id: monument.to_param, monument: new_attributes}, session: valid_session
        monument.reload
      ...
      it "assigns the requested monument as @monument" do
        monument = Monument.create! valid_attributes
        put :update, params: {id: monument.to_param, monument: valid_attributes}, session: valid_session
        expect(assigns(:monument)).to eq(monument)
      end
      ...
      it "redirects to the monument" do
        monument = Monument.create! valid_attributes
        put :update, params: {id: monument.to_param, monument: valid_attributes}, session: valid_session
        expect(response).to redirect_to(monument)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the monument as @monument" do
        monument = Monument.create! valid_attributes
        put :update, params: {id: monument.to_param, monument: invalid_attributes}, session: valid_session
        expect(assigns(:monument)).to eq(monument)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested monument" do
      monument = Monument.create! valid_attributes
      expect {
        delete :destroy, params: {id: monument.to_param}, session: valid_session
      }.to change(Monument, :count).by(-1)
    end
    ...
    it "redirects to the monuments list" do
      monument = Monument.create! valid_attributes
      delete :destroy, params: {id: monument.to_param}, session: valid_session
      expect(response).to redirect_to(monuments_url)
    end
  end
